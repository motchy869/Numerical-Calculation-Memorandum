    ...
    \section{rank-one update}
        ...
        \begin{derivation*}
            ...
            \begin{align*}
                ...
                &= \tilde{\bm{l}_1}\tilde{\bm{l}_1}^* + \tilde{\bm{x}}\tilde{\bm{xl}}^* - \frac{1}{r^2}\left(\abs{x_1}^2\tilde{\bm{l}_1}\tilde{\bm{l}_1}^* + l_{1,1}^2\tilde{\bm{x}}\tilde{\bm{xl}}^* - l_{1,1}x_1\tilde{\bm{l}_1}\tilde{\bm{x}}^*\right)
            \end{align*}
            \qed
        \end{derivation*}
