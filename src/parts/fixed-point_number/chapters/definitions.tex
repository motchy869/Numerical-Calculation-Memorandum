\chapter{定義}
    \newcommand{\Ni}{{N_\mathrm{int}}}
    \newcommand{\Nd}{{N_\mathrm{dec}}}
    \section{前提}
    ...
    \section{積}
        \newcommand{\Nia}{{N_{\mathrm{int},a}}}
        \newcommand{\Nda}{{N_{\mathrm{dec},a}}}
        \newcommand{\Nib}{{N_{\mathrm{int},b}}}
        \newcommand{\Ndb}{{N_{\mathrm{dec},b}}}
        \subsection{定義}
